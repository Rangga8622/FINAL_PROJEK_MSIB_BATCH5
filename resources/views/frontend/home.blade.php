...
<hr>
                <div id="team" class="page-section">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="row">
                                <div class="col-lg-6 col-sm-12 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="hover-top-in text-center">
                                    <img class="rounded-circle border border-5 border-white shadow" src="{{ asset('team/img/rangga.png') }}" alt="">
                                ...
                                <div class="col-lg-6 col-sm-12 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="hover-top-in text-center">
                                    <img class="rounded-circle border border-5 border-white shadow" src="{{ asset('team/img/dimas.png') }}" alt="">
                                        <div class="mx-2 mx-xl-3 shadow rounded-3 position-relative mt-n4 bg-white p-4 pt-6 mx-4 text-center hover-top--in">
                                            <h6 class="fw-700 dark-color mb-1">Dimas Andhika Firmansyah</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="hover-top-in text-center">
                                    <img class="rounded-circle border border-5 border-white shadow" src="{{ asset('team/img/salsa.png') }}" alt="">
                                        <div class="mx-2 mx-xl-3 shadow rounded-3 position-relative mt-n4 bg-white p-4 pt-6 mx-4 text-center hover-top--in">
                                ...
                                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="hover-top-in text-center">
                                    <img class="rounded-circle border border-5 border-white shadow" src="{{ asset('team/img/jhofy.png') }}" alt="">
                                        <div class="mx-2 mx-xl-3 shadow rounded-3 position-relative mt-n4 bg-white p-4 pt-6 mx-4 text-center hover-top--in">
                                ...
                                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="hover-top-in text-center">
                                    <img class="rounded-circle border border-5 border-white shadow" src="{{ asset('team/img/milda.png') }}" alt="">
                                        <div class="mx-2 mx-xl-3 shadow rounded-3 position-relative mt-n4 bg-white p-4 pt-6 mx-4 text-center hover-top--in">

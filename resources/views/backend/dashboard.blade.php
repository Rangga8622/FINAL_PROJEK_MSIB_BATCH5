                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">{{$jumlah_organisasi}}</h3>
                            <i class="bi bi-diagram-3-fill btn-lg text-muted mb-0 mb-md-3 mb-xl-0"></i>
                        </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                            <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">tes</h3>

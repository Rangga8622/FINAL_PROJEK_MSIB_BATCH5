                    ...
                    <form class="forms-sample" method="POST" action="{{ route('artikel.update', $rs->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama"
                                ...
                                id="exampleInputSmt" id="exampleInputSmt" placeholder="Nama" value="{{ $rs->nama }}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('idkategori') is-invalid @else is-valid @enderror"
                                ...
                                <option value="{{ $kategori->id }}" @if ($kategori->id == old('idkategori',
                                    $rs->idkategori)) selected @endif>
                                    {{ $kategori->nama }}
                                </option>
                                @endforeach
                            </select>

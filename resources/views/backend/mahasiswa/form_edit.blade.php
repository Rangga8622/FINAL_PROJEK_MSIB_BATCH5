        ...
        <div class="card-body">
          ...
          enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="number" name="semester" class="form-control" id="exampleInputSmt" placeholder="Name" value="{{ $rs->semester }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nohp" class="form-control" id="exampleInputHP" placeholder="Name" value="{{ $rs->nohp }}">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail3">Email</label>
              <input type="email" class="form-control" name="email" id="exampleInputEmail3" placeholder="Email" value="{{ $rs->email }}">
            </div>
            <div class="form-group">
